...
// var resultAdd = AddProduct(categoryId: 6, productName: "Bob's Burgers", price: 540M, stock: 72);
...
// if (resultUpdateBetter.affected > 0) { WriteLine("Increase product price successful."); }
